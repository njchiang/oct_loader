import numpy as np
from construct import PaddedString, Int8un, Int16un, Struct, Int32sn, Int32un, Array
...
class E2E(object):
    ...
    def __init__(self, filepath):
        ...
        self.patinfo_structure = Struct(
            'given_name' / PaddedString(31, 'ascii'), 
        ...
        self.laterality_structure = Struct(
            'unknown0' / PaddedString(14, 'ascii'),
